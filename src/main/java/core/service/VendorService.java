...
public class VendorService {
	...
	// Add ProductVendor
	public void addProductVendor(Product product, Vendor vendor, Double price, Double discount) {
		ProductVendor productVendor = new ProductVendor(product, vendor, price, discount);
